...
def get_notion_pages_with_relation():
    ...
    for page in results:
        ...
        # 企業名
        name = "不明"
        title_arr = props.get("記事スクラップ1", {}).get("title", []) or props.get("名前", {}).get("title", [])
...
if __name__ == "__main__":
    ...
    if mode == "GENERATE":
        ...
        for item in targets:
            ...
            create_two_company_cf_chart(comp_a_name, comp_b_name, sample_cf_a, sample_cf_b, rel_path)
